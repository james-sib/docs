...
<AccordionGroup>
    ...
    <Accordion title="CLI commands" icon="terminal">
        ...
        | `deepagents deploy`             | Beta deploy command. New deployments should use [Managed Deep Agents](/langsmith/deploy-managed-deep-agent); see [CLI deploy (beta)](/oss/python/deepagents/deploy/overview) for the existing CLI surface |
