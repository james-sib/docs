...
For what's new in the v1 hook—selector hooks, always-on root projections, Suspense, multimodal media, pluggable transports—see [What's new in LangGraph v1: Frontend SDK enhancements](/oss/javascript/releases/langgraph-v1#frontend-sdk-enhancements).
