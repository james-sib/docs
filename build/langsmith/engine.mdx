...
<Steps>
  ...
  <Step title="Start analyzing">
    Click **Start Analyzing**. LangSmith Engine can take up to 20 minutes to analyze your project’s traces and begin making suggestions. While you wait, you can configure provider keys and webhooks in the [settings panel](#configure-the-langsmith-engine) to be notified when issues of different priority levels are found.
  </Step>
