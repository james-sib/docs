...
<Note>
You can also create an LLM-as-a-judge evaluator that appears in the LangSmith UI programmatically with the SDK. Refer to [Manage evaluators with the SDK](/langsmith/manage-evaluators-sdk).
