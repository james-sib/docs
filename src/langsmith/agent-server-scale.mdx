...
Minimize redundant checkpointing by setting [`durability`](/oss/langgraph/persistence#durability-modes) to the minimum value necessary to ensure your data is durable.
