...
From the [`langsmith-cursor-plugins`](https://github.com/langchain-ai/langsmith-cursor-plugins) repository, install dependencies and build the hooks:
