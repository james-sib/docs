...
sidebarTitle: Hybrid
icon: "cloud"
description: Hybrid is a platform setup for LangSmith Deployment where you self-host Agent Servers in your infrastructure and send traces to LangSmith Cloud or a self-hosted LangSmith instance.
---
