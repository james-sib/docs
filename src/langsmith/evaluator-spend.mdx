...
- **Spend (this week)**: Total LLM cost for the evaluator across all attached projects and datasets since Monday 12AM UTC. Sortable. Evaluators that do not call an LLM (for example, code evaluators) show no value.
...
- **Current spend**: Progress bar showing spend against the limit since Monday 12AM UTC.
