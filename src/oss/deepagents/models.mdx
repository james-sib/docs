...
| [OpenAI](/oss/integrations/providers/openai) | `gpt-5.5-pro`, `gpt-5.5`, `gpt-5.4-pro`, `gpt-5.4`, `gpt-5.4-mini` |
| [Anthropic](/oss/integrations/providers/anthropic) | `claude-opus-4-7`, `claude-opus-4-6`, `claude-sonnet-4-6` |
| Open-weight | `DeepSeek-V4-Pro`, `DeepSeek-V4-Flash`, `Kimi-K2.6`, `GLM-5.1`, `GLM-5`, `MiniMax-M2.7`, `qwen3.6-plus` |
